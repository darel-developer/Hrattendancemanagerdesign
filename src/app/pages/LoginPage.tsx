...
export function LoginPage() {
  ...
  const [role, setRole] = useState<"Admin" | "Manager" | "Employé">("Admin");
  ...
  return (
    <div className="min-h-screen flex" style={{ background: "#F0F2F8" }}>
      ...
      >
        ...
        />
        <div
          className="absolute top-1/2 left-1/2 w-48 h-48 rounded-full opacity-5"
          style={{
        ...
        <div className="relative z-10 flex flex-col h-full p-12">
          ...
          <div className="flex items-center gap-3 mb-16">
            ...
            <div>
              <p className="text-white text-lg" style={{ fontWeight: 800, letterSpacing: "-0.5px" }}>
                HR Manager
              </p>
          ...
          >
            {[
              ...
              >
                <p className="text-white text-xl" style={{ fontWeight: 800 }}>
                  {s.val}
                </p>
      ...
      >
        <div className="w-full max-w-md">
          ...
          <h1 className="text-slate-800 mb-2" style={{ fontWeight: 800, fontSize: "1.75rem" }}>
            Bienvenue 👋
          </h1>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-3 gap-2">
              {demoAccounts.map((acc) => (
                <button
                  key={acc.role}
                  onClick={() => { setRole(acc.role as any); setEmail(acc.email); }}
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="text-xs mb-1.5 block" style={{ color: "#374151", fontWeight: 600 }}>
                Adresse email
              </label>
            ...
            <div className="flex items-center justify-between">
              ...
              <button type="button" className="text-xs text-indigo-600 hover:text-indigo-700" style={{ fontWeight: 600 }}>
                Mot de passe oublié ?
              </button>
            </div>
